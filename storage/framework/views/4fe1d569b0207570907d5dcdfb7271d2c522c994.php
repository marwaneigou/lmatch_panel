        ...
        <?php if (! (auth()->user()->type === 'Admin')): ?>
          <li class="nav-item  res">
            <div class="nav-link p-0">
              ...
              <strong class="res-credit d-block" style="color:yellow;">&nbsp; (<?php echo e(auth()->user()->solde); ?>

                &nbsp;<?php echo e(trans('lang.credits')); ?>)</strong>
              <strong class="res-credit d-block" style="color:yellow;">&nbsp; (<?php echo e(auth()->user()->solde_test); ?>

                &nbsp;<?php echo e(trans('lang.creditsTest')); ?>)</strong>
              <strong class="res-credit d-block" style="color:yellow;">&nbsp; (<?php echo e(auth()->user()->solde_app); ?>

                &nbsp;<?php echo e(trans('lang.creditsApp')); ?>)</strong>
              <strong class="res-credit d-block" style="color:yellow;">&nbsp; (<?php echo e(auth()->user()->gift); ?>

                &nbsp;<?php echo e(trans('lang.gift')); ?>)</strong>
            </div>
          </li>
        <?php endif; ?>
      </ul>
...
</html><?php /**PATH C:\Users\igour\Desktop\lmatch_panel\resources\views/layouts/master.blade.php ENDPATH**/ ?>