		...
		<!-- <input type="checkbox" id="chk" aria-hidden="true"> -->
			...
			<div class="signup">
				...
				<?php echo csrf_field(); ?>
					...
					<div class="col-12">
						<input id="name" type="text" placeholder="User" class="form-control <?php $__errorArgs = ['name'];
...
<?php /**PATH C:\Users\igour\Desktop\lmatch_panel\resources\views/auth/login.blade.php ENDPATH**/ ?>