      ...
      <div>
        <select name="lang" id="lang" class="form-control" onchange="setLang()">
          <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($locale); ?>" <?php if(app()->getLocale() == $locale): ?> selected="selected" <?php endif; ?>> <img
                src="<?php echo e('assets/img/flags/en.png'); ?>" alt=""> <?php echo e(__('lang.' . $locale)); ?></option>
          ...
          <li class="nav-item res mt-3 border-top border-white-10 pt-3">
            <div class="nav-link p-0 px-3">
              <div class="d-flex justify-content-between align-items-center mb-1">
                <span class="text-xs text-slate-400 uppercase tracking-wider"><?php echo e(trans('lang.credits')); ?></span>
                <strong class="text-emerald-400"><?php echo e(auth()->user()->solde); ?></strong>
              </div>

              <?php if(auth()->user()->solde_test > 0): ?>
                <div class="d-flex justify-content-between align-items-center mb-1">
                  <span class="text-xs text-slate-400 uppercase tracking-wider"><?php echo e(trans('lang.creditsTest')); ?></span>
                  <strong class="text-emerald-400"><?php echo e(auth()->user()->solde_test); ?></strong>
                </div>
              <?php endif; ?>

              <?php if(auth()->user()->solde_app > 0): ?>
                <div class="d-flex justify-content-between align-items-center mb-1">
                  <span class="text-xs text-slate-400 uppercase tracking-wider"><?php echo e(trans('lang.creditsApp')); ?></span>
                  <strong class="text-emerald-400"><?php echo e(auth()->user()->solde_app); ?></strong>
                </div>
              <?php endif; ?>

              <?php if(auth()->user()->gift > 0): ?>
                <div class="d-flex justify-content-between align-items-center">
                  <span class="text-xs text-slate-400 uppercase tracking-wider"><?php echo e(trans('lang.gift')); ?></span>
                  <strong class="text-emerald-400"><?php echo e(auth()->user()->gift); ?></strong>
                </div>
              <?php endif; ?>
            </div>
          </li>
...
</html><?php /**PATH C:\Users\igour\Desktop\abdelali\resources\views/layouts/master.blade.php ENDPATH**/ ?>