            ...
            <div>             
              <select name="lang" id="lang" class="form-control" onchange="setLang()">
                @foreach (config('app.available_locales') as $locale)
                  <option value="{{$locale}}" @if (app()->getLocale() == $locale) selected="selected" @endif> <img src="{{'assets/img/flags/en.png'}}" alt=""> {{ __('lang.'.$locale) }}</option>
                @endforeach
              </select>
            </div>
                ...
                @unless(auth()->user()->type ==='Admin')
                  <li class="nav-item  res">
                      <div class="nav-link p-0">
                           <!--<span class="res-nom">{{auth()->user()->name}} </Span>-->
                           <strong class="res-credit d-block" style="color:yellow;">&nbsp; ({{auth()->user()->solde}} &nbsp;{{trans('lang.credits')}})</strong>
                           <strong class="res-credit d-block" style="color:yellow;">&nbsp; ({{auth()->user()->solde_test}} &nbsp;{{trans('lang.creditsTest')}})</strong>
                           <strong class="res-credit d-block" style="color:yellow;">&nbsp; ({{auth()->user()->solde_app}} &nbsp;{{trans('lang.creditsApp')}})</strong>
                           <strong class="res-credit d-block" style="color:yellow;">&nbsp; ({{auth()->user()->gift}} &nbsp;{{trans('lang.gift')}})</strong>
                      </div>
                  </li>
                @endunless
            </ul>
