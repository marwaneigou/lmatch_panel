...
class MagDeviceController extends Controller
{
            ...
            if ($user_type != 'Admin') {
                ...
                if ($pack->is_trial == 0) {
                    ...
                    TransactionLog::create([
                        'reseller_id' => $user_id,
                        'target_id' => $id, // This $id is from mag_devices insert earlier
                        'target_type' => 'mag_device',
                        'action' => 'create',
                        'amount' => $ss,
                        'old_balance' => $sld->solde + $ss,
                        'new_balance' => $sld->solde,
                        'details' => 'Created Mag Device ' . $mac,
                        'ip' => request()->ip()
                    ]);
                } else {
                    if ($sld->solde_test - $ss < 0) {
                ...
                TransactionLog::create([
                    ...
                    'action' => 'create',
                    'amount' => 0,
                    'details' => 'Created Mag Device ' . $mac . ' (Admin)',
                    'ip' => request()->ip()
                ]);
            }
            DB::commit();
    ...
    public function update(Request $request, $id)
    {
        ...
        TransactionLog::create([
            ...
            'target_type' => 'mag_device',
            'action' => 'update',
            'details' => 'Updated Mag Device ' . $request->mac,
            'ip' => request()->ip()
        ]);
    }
        ...
        try {
            ...
            if ($type == 'disabled') {
                ...
                TransactionLog::create([
                    ...
                    'target_type' => 'mag_device',
                    'action' => 'disable',
                    'details' => 'Disabled Mag Device ' . $mmac,
                    'ip' => request()->ip()
                ]);
                ...
                TransactionLog::create([
                    ...
                    'target_type' => 'mag_device',
                    'action' => 'transfer',
                    'details' => 'Transferred Mag Device ' . $mmac,
                    'ip' => request()->ip()
                ]);
                ...
                TransactionLog::create([
                    ...
                    'target_type' => 'mag_device',
                    'action' => 'delete',
                    'details' => 'Deleted Mag Device ' . $mmac,
                    'ip' => request()->ip()
                ]);
    ...
    public function Renew(Request $request, $mac)
    {
        ...
        if ($user_type != 'Admin') {
            ...
            TransactionLog::create([
                ...
                'old_balance' => $sld->solde + $ss,
                'new_balance' => $sld->solde,
                'details' => 'Renewed Mag Device ' . $mac,
                'ip' => request()->ip()
            ]);
            ...
            TransactionLog::create([
                ...
                'action' => 'renew',
                'amount' => 0,
                'details' => 'Renewed Mag Device ' . $mac . ' (Admin)',
                'ip' => request()->ip()
            ]);
        }
    }
