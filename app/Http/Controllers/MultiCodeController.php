...
public function store(Request $request)
{
    ...
    try {
        ...
        $durationMapping = [
            '1_years' => 365, '1_months' => 30, '3_months' => 90,
            '6_months' => 180, '24_hours' => 1, '10_days' => 10,
            '2_months' => 60, '366_days' => 366,
        ];
...
private function generateSinglePassword(): string
{
    ...
    public function getSolde()
    {
        ...
        if($user->type != 'Admin') { return response()->json(['solde'=>floatval($user->solde), 'solde_test'=>floatval($user->solde_test)]); }
    ...
    public function get_code(Request $request) {
        ...
        $package_id = "141";
        $pack = [
            231, 70, 71, 116, 118, 76, 64, 82, 83, 84, 85, 167, 130, 143, 86, 87,
            90, 89, 75, 74, 98, 91, 120, 121, 93, 81, 142, 95, 97, 96, 100, 101,
            149, 102, 104, 127, 103, 128, 105, 144, 179, 155, 109, 134, 133, 107,
            136, 114, 111, 135, 113, 115, 174, 117, 108, 38, 151, 186, 187, 188,
            196, 197, 158
        ];
